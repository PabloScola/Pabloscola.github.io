...
let html = document.getElementById("Lorem");
crearBarra(html);
let javascript = document.getElementById("Ipsum");
crearBarra(javascript);
let wordpress = document.getElementById("Cras");
crearBarra(wordpress);
let photoshop = document.getElementById("Aliquam");
crearBarra(photoshop);
let php = document.getElementById("Tellus");
crearBarra(php);
let ilustrator = document.getElementById("Tincidunt");
